...
class Dataset():
    def __init__(self, csv_file, transform=None, pseudo_label=None, threshold=0.7):
    ...
    def __getitem__(self, idx):
        ...
        label = 1 if "tumor" in temp_path else 0
...
#        /single/training/normal_001/24_181.jpeg
        ...
        return sample, torch.LongTensor(np.array([label])), (slide_name, patch_name)
...
class DataSetWrapper(object):
    ...
    def __init__(self, batch_size, num_workers, valid_size, input_shape, s, pseudo_label=None, threshold=0.7):
    ...
    def get_data_loaders(self):
        ...
        train_dataset = Dataset(csv_file='all_patches.csv', transform=SimCLRDataTransform(data_augment), pseudo_label=self.pseudo_label, threshold=self.threshold)
